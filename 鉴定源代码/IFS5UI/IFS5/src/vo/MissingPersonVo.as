package vo
{
	...
	public class MissingPersonVo implements ValueObject
	{
		public function MissingPersonVo(ID:String,CONNO:String,NAME:String,SAMPLE_TYPE:String,
								 ...
								 REMARK:String,CASE_NAME:String,SLN:String,ORA_FLAG:String)
		{
			this.ID=ID;
			this.CONNO=CONNO;
			this.NAME=NAME;
