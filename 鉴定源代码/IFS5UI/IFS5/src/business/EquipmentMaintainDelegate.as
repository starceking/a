package business
{
	...
	public class EquipmentMaintainDelegate
	{
		public function EquipmentMaintainDelegate(responder:IFSCommand)
		{
		...
		private function get Ws():WebService
		{
			...
			{
				ws=new WebService(); 
				ws.loadWSDL(Server.getWsUrl("设备维护记录WS"));
		...
		{
			var voObj:EquipmentMaintainVo=EquipmentMaintainLocator.getInstance().wsObj;
			Ws.Insert.send(voObj.ID,voObj.SBID,voObj.WFR,voObj.WFSJ,voObj.WHNR,voObj.RESULT);
			
		}
		public function update():void
		{
			var voObj:EquipmentMaintainVo=EquipmentMaintainLocator.getInstance().wsObj;
			Ws.Update.send(voObj.ID,voObj.SBID,voObj.WFR,voObj.WFSJ,voObj.WHNR,voObj.RESULT);
