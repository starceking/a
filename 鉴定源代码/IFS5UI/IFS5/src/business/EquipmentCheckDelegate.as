package business
{
	...
	public class EquipmentCheckDelegate
	{
		public function EquipmentCheckDelegate(responder:IFSCommand)
		{
		...
		private function get Ws():WebService
		{
			...
			{
				ws=new WebService(); 
				ws.loadWSDL(Server.getWsUrl("设备期间核查记录WS"));
		...
		{
			var voObj:EquipmentCheckVo=EquipmentCheckLocator.getInstance().wsObj;
			Ws.Insert.send(voObj.ID,voObj.SBID,voObj.HCR,voObj.JDR,voObj.HCJG,voObj.HCRQ,voObj.HCNR);
			
		}
		public function update():void
		{
			var voObj:EquipmentCheckVo=EquipmentCheckLocator.getInstance().wsObj;
			Ws.Update.send(voObj.ID,voObj.SBID,voObj.HCR,voObj.JDR,voObj.HCJG,voObj.HCRQ,voObj.HCNR);
