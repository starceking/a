package locator
{
	...
	public class CasePersonnelSampleXyrLocator implements ModelLocator
	{
		//Singleton
		private static var locObj:CasePersonnelSampleXyrLocator;
		public static function getInstance():CasePersonnelSampleXyrLocator
		{
			if(locObj==null)
			{
				locObj=new CasePersonnelSampleXyrLocator();
			}
			return locObj;
		}
		//For the view
