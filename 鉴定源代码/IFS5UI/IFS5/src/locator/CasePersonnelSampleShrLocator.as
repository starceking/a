package locator
{
	...
	public class CasePersonnelSampleShrLocator implements ModelLocator
	{
		//Singleton
		private static var locObj:CasePersonnelSampleShrLocator;
		public static function getInstance():CasePersonnelSampleShrLocator
		{
			if(locObj==null)
			{
				locObj=new CasePersonnelSampleShrLocator();
			}
			return locObj;
		}
		//For the view
