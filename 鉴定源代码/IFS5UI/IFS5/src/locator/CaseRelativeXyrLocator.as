package locator
{
	...
	public class CaseRelativeXyrLocator implements ModelLocator
	{
		//Singleton
		private static var locObj:CaseRelativeXyrLocator;
		public static function getInstance():CaseRelativeXyrLocator
		{
			if(locObj==null)
			{
				locObj=new CaseRelativeXyrLocator();
			}
			return locObj;
		}
		//For the view
