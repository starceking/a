function dict_cg_GetList(table, parent_id, val) {
    dict_cg_SetIdName(table);

    var json = eval("(" + dict_cg_json + ")");
    if (parent_id.length != 12) parent_id = "000000000000";
...
function dict_cg_SetIdName(table) {
